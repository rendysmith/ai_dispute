...
Имейте в виду, что первое имя не всегда стоит на первом месте в паре. Не используйте имя, если оно является прозвищем, написано по-английски набором букв или указано как Аноним.
