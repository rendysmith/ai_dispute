...
НЕ используйте имя, если оно является прозвищем, написано по-английски, состоит или имеет набор букв или цифр или указано как Аноним или Инкогнито. 
Если сомневаешься, игнорируй имя и пиши сразу 'Здравствуйте!'
Обязательно проанализируй имя автора - прежде чем использовать его.
